    ...
    return (
        <div>
          <div className="masthead">
					...
					<div className='item'>
						<h2>Microstructure reconstruction via artificial neural networks: A combination of causal and non-causal approach</h2>
						...
						<img src={Causal} alt="" width='70%' height='auto' padding='20px' style={{minWidth: MIN_ELEMENT_WIDTH * w}} />
						<img src={NonCausal} alt="" width='70%' height='auto' padding='20px' style={{minWidth: MIN_ELEMENT_WIDTH * w}} />
					</div>
        </div>
    )
}
